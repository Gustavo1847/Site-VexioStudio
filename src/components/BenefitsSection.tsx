      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div ref={ctaRef} className="bg-gradient-to-r from-vexio-orange to-vexio-orange-light rounded-3xl p-8 md:p-12 text-center">
            ...
            <button 
              onClick={() => window.open('https://wa.me/5583986222218?text=Ol%C3%A1%2C%20tudo%20bom%3F%0AVim%20do%20site%2C%20e%20quero%20ver%20minha%20empresa%20crescer%20com%20IA%21', '_blank')}
